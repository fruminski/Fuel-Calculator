    ...
    <div className="more-details-container">
      <div className="additional-info">
        <div className="details">
          <div className="row">
            <p>Motorway distance:</p>
            <p className="values">{motorwayDistance} miles</p>
          </div>
          <div className="row">
            <p>non-Motorway distance:</p>
            <p className="values">{nonMotorwayDistance} miles</p>
          </div>
          <div className="row">
            <p>CO₂ emissions:</p>
            <p className="values">{co2Emissions} g/km</p>
          </div>
          <div className="row">
            <p>Cost per mile:</p>
            <p className="values">£{costPerMile}</p>
          </div>
        </div>
        ...
        <div className="details">
          <div className="row">
            <p>at 60 mph:</p>
            <p className="values">
              £{(costMotorwayAt60 + costNonMotorway).toFixed(2)}
            </p>
          </div>
          <div className="row">
            <p>at 70 mph:</p>
            <p className="values">
              £{(costMotorwayAt70 + costNonMotorway).toFixed(2)}
            </p>
          </div>
          <div className="row">
            <p>at 80 mph:</p>
            <p className="values">
              £{(costMotorwayAt80 + costNonMotorway).toFixed(2)}
            </p>
          </div>
        </div>
      </div>
